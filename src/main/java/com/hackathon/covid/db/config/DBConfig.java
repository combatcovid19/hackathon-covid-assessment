...
@EnableJpaRepositories(basePackages = { "com.hackathon.covid.assessment.repo" }, entityManagerFactoryRef = "sourceEntityManager", transactionManagerRef = "sourceTransactionManager")
