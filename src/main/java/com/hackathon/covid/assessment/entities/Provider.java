...
@NamedStoredProcedureQuery(name = Provider.PROCEDURE_NAME, procedureName = Provider.PROCEDURE_ENTITY, resultClasses = Provider.class, parameters = {

		@StoredProcedureParameter(mode = ParameterMode.IN, name = "RADIUS", type = Integer.class),

		@StoredProcedureParameter(mode = ParameterMode.IN, name = "LAT", type = String.class),

		@StoredProcedureParameter(mode = ParameterMode.IN, name = "LONG", type = String.class) })

public class Provider implements Serializable {

	private static final long serialVersionUID = 1L;

	public static final String PROCEDURE_NAME = "calculateProviderDistanceFromAssesse";

	public static final String PROCEDURE_ENTITY = "dbo.calculateProviderDistanceFromAssesse";
	...
	public void setProvider_Latitude(String provider_Latitude) {

		this.provider_Latitude = provider_Latitude;

	}

	public String getProvider_Longitude() {

		return this.provider_Longitude;

	}

	public void setProvider_Longitude(String provider_Longitude) {
	...
	public long getProvider_Pin_Zip_Code() {

		return this.provider_Pin_Zip_Code;

	}

	public void setProvider_Pin_Zip_Code(long provider_Pin_Zip_Code) {
